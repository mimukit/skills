...
| **orcakit** | worktree lifecycle, base ref, branch naming | Drops `orca worktree create` / `orca worktree rm`; stops hard-coding `origin/main`. Residue is the `ready` guard plus label flips. **Slated for deletion** — see [plan-orcakit-deletion-2026-08-02.md](0010-plan-orcakit-deletion-2026-08-02.md). |
