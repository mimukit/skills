...
| **Output** | **Print the artifact inline by default; write a file only when asked.** When saved: `docs/research/research-<slug>.md`, following any existing research/notes/RFC location the repo already uses. |
